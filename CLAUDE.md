...
Note: no dedicated lab environment (domain controller, isolated
workstation) is available for this project. EVTX samples from
Module 3/8 are used in place of live Atomic Red Team execution.
